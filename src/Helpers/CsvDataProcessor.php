...
class CsvDataProcessor
{
    ...
    public function processParsedCsvData($csvData)
    {
        Collect($csvData)->each(function ($row) {
            ...
            //$accessRate =  $this->createRecordFromCsv($row, $this->reflections['AccessRateService']);
            //$this->checkRecordWasRecentlyCreated($accessRate,'access_rate');
            ...
            $meterType = $this->createRecordFromCsv($row, $this->reflections['MeterTypeService']);
            $row['meter_type_id'] = $meterType->id;
